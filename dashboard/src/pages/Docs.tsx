    ...
    "channels": ["EMAIL"]
            ...
            {activeTab === 'node' && (
              <pre style={{ overflowX: 'auto', fontSize: '0.85rem', color: '#abb2bf', lineHeight: '1.6', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', margin: 0 }}>
                <code dangerouslySetInnerHTML={{ __html: `<span style="color: #c678dd">const</span> <span style="color: #e5c07b">response</span> = <span style="color: #c678dd">await</span> <span style="color: #61afef">fetch</span>(<span style="color: #98c379">'http://localhost:3000/api/notify/v1'</span>, {
